    ...
    <section className="pt-12 pb-16 xl:pt-16 xl:pb-36">
      <div className="container mx-auto">
        <div className="flex flex-col gap-4 mb-12 xl:mb-24">
          ...
          <p className="text-center max-w-[628px] mx-auto">
          Lorem ipsum dolor, sit amet consectetur adipiscing elit. Quam
          laborum, non voluptatem minima voluptas dolorem suscipit atque
          perferendis ad? Quo.
        </p>
        </div>
        {/* menu & btn */}
      ...
      {/**btn */}
      <button className="btn bg-[#d2a679] text-[#2f2f2f] uppercase tracking-wider px-6 py-3 rounded-md">
          View full menu
        </button>
      </div>
